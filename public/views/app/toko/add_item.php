<div class="card">
    <div class="card-body">
        <form action="<?= base_url('toko/add_new_item') ?>" method="post" class="form-image">
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="custom-file col">
                        <input type="file" name="foto_item" class="custom-file-input upload-foto" required />
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_item" id="nama_item" class="form-control" placeholder="Nama Item" required />
                        <input type="hidden" name="toko_id" value="<?= $toko_id ?>">
                    </div>
                    <div class="form-group">
                        <label for="deskripsi_item">Deskripsi Item</label>
                        <textarea name="deskripsi_item" id="deskripsi_item" cols="30" rows="5" class="form-control" placeholder="Isi keterangan Item" required></textarea>
                    </div>
